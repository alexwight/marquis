...
/**
 * Define the ~/.maquis path as a constant.
 */
define('MARQUIS_HOME_PATH', $_SERVER['HOME'].'/.marquis');
define('MARQUIS_SERVER_PATH', realpath(__DIR__ . '/../../server.php'));
define('MARQUIS_STATIC_PREFIX', '41c270e4-5535-4daa-b23e-c269744c2f45');
