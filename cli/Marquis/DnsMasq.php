...
class DnsMasq
{
    ...
    public function install($domain = 'test')
    {
        ...
        // in the main DnsMasq file. This allows Marquis to make changes to our own files
    ...
    /**
     * Determine if Marquee's custom DnsMasq configuration is being imported.
     *
     * @param  string  $customConfigPath
     * @return bool
     */
    ...
    {
        return $_SERVER['HOME'].'/.marquis/dnsmasq.conf';
    }
}
