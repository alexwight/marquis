...
class Configuration
{
    ...
    /**
     * Create a new Marquis configuration class instance.
     *
    ...
    /**
     * Install the Marquis configuration file.
     *
     * @return void
     */
    ...
    /**
     * Create the Marquis configuration directory.
     *
     * @return void
     */
    public function createConfigurationDirectory()
    {
        $this->files->ensureDirExists(MARQUIS_HOME_PATH, user());
    }

    /**
     * Create the Marquis sites directory.
     *
     * @return void
     */
    public function createSitesDirectory()
    {
        $this->files->ensureDirExists(MARQUIS_HOME_PATH.'/Sites', user());
    }
    ...
    {
        $this->files->ensureDirExists(MARQUIS_HOME_PATH.'/Log', user());

        $this->files->touch(MARQUIS_HOME_PATH.'/Log/nginx-error.log');
    }
    ...
    {
        $this->files->ensureDirExists(MARQUIS_HOME_PATH.'/Certificates', user());
    }

    /**
     * Write the base, initial configuration for Marquis.
     */
    ...
    {
        return MARQUIS_HOME_PATH.'/config.json';
    }
}
